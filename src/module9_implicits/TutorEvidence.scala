...
object TutorEvidence extends App {
  ...
  // TODO define method younger in Pair taking parameter evidence
  // TODO which bounds type to Person and its descendants
  ...
  //println( pair.younger.name ) // John TODO uncomment this
}
